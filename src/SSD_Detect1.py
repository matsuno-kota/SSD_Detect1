...
ssd_detect1_spec = ["implementation_id", "SSD_Detect1", 
		 "type_name",         "SSD_Detect1", 
...
# 
# 
class SSD_Detect1(OpenRTM_aist.DataFlowComponentBase):
...
def SSD_Detect1Init(manager):
    profile = OpenRTM_aist.Properties(defaults_str=ssd_detect1_spec)
    manager.registerFactory(profile,
                            SSD_Detect1,
                            OpenRTM_aist.Delete)

def MyModuleInit(manager):
    SSD_Detect1Init(manager)

    # Create a component
    comp = manager.createComponent("SSD_Detect1")
